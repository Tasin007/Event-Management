  ...
  return (
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <img
          data-aos="fade-down"
          src="https://i.ibb.co/8zK8Pcn/FAQ.jpg"
        ...
        <div className="w-1/2 mr-8">
          ...
          <div className="collapse collapse-arrow bg-amber-200">
            ...
            <div className="collapse-content">
              <p>
                {" "}
                Our cancellation policy allows you to cancel your booking up to
                48 hours before the event for a full refund. Cancellations made
                within 48 hours are subject to our refund policy.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow bg-cyan-200">
            ...
            <div className="collapse-content">
              <p>
                Our customer support team is available 24/7. You can contact us
                through our contact page, email us at
                support@healthandwellnessevents.com, or call our toll-free
